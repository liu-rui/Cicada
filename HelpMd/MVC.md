...
### 这是有关MVC类型项目的介绍，使用主要注意一下几点：
	
  * 1 MVC项目，通过NuGet程序包搜索“Cicada”，在结果里面有一个"Cicada.Boot.Aspnet.MVC",安装到MVC项目即可;
		同样安装一下Cicada.Data.EntityFramework，然后MVC项目涉及到框架的东西基本引用完毕。
  * 2 在MVC项目中找到Cicada.properties文件，打开编辑其中对应的链接即可，具体介绍如下：
